...
import com.example.pinky_player.ViewModelUserPickedSongs
...
import com.example.pinky_player.databinding.FragmentSongBinding
import com.example.pinky_player.media_controller.BitmapLoader
...
import com.example.pinky_player.media_controller.MediaPlayerWUri
import com.example.pinky_player.random_playlist.AudioUri
...
class FragmentSong : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        mediaController.currentAudioUri.observe(viewLifecycleOwner) {
            if (it != null) {
                currentAudioUri = it
        ...
        mediaController.isPlaying.observe(viewLifecycleOwner) { b: Boolean? ->
            if (b != null) {
    ...
    override fun onDestroy() {
        ...
        shutDownSeekBarUpdater()
        mediaController.isPlaying.removeObservers(this)
        mediaController.currentAudioUri.removeObservers(this)
    }
