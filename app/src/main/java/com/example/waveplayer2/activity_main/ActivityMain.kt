...
import com.example.waveplayer2.databinding.ActivityMainBinding
...
import com.example.waveplayer2.media_controller.ServiceMain
...
class ActivityMain : AppCompatActivity() {
    ...
    private fun setUpViewModelActivityMainObservers() {
        ...
        viewModelActivityMain.fabImage.observe(this) { drawableID: Int? ->
            val fab: ExtendedFloatingActionButton = binding.fab
            if (drawableID != null) {
                fab.icon = ResourcesCompat.getDrawable(resources, drawableID, null)
            }
        }
