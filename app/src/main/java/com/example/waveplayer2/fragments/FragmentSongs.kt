...
import com.example.waveplayer2.databinding.RecyclerViewSongListBinding
            ...
            if (itemSearch != null) {
                ...
                searchView.setOnQueryTextListener(object : SearchView.OnQueryTextListener {
                    ...
                    override fun onQueryTextChange(newText: String?): Boolean {
                        val recyclerViewSongs: RecyclerView = activityMain.findViewById(R.id.recycler_view_song_list)
